    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-teal-50 to-lime-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        ...
        <Card>
          ...
          {/* Formulario de email/password (opcional) */}
          ...
          <div className="mt-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
            <p className="text-sm text-gray-600 text-center">
              Para usar email/password, primero debes crear una cuenta con Google o GitHub, 
              o configurar usuarios manualmente en Supabase.
            </p>
          </div>
        </Card>
      </div>
